...
| C-08 | 打卡成功 — 分享 | ❌ Fail (P2) | 打卡成功後無分享功能，詳見缺陷說明 |
...
#### BUG-7：C-08 打卡成功後無分享功能（[AGO-188](https://ai360c.atlassian.net/browse/AGO-188)）
...
| 問題說明 | 打卡成功後，頁面上沒有看到分享功能按鈕，無法進行打卡照片或資訊分享至 LINE 聊天室。兩個測試步驟均失敗：(1) 打卡成功後點「分享」→ 預期開啟 LINE/系統分享面板，實際無此功能；(2) 分享至 LINE 聊天室 → 預期對方收到合成照片，實際無法操作 |
| 預期行為 | 打卡成功後應提供「分享」按鈕，點擊後開啟 LINE/系統分享面板，可將合成照片分享至 LINE 聊天室 |
| 截圖 | 已附於 MeterSphere 案例（IMG_5916.png） |
